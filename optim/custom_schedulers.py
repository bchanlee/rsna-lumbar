...
class OneCycleLR(LRScheduler):
    ...
    def __init__(self,
        ...
        # Set up linear for warmup and cosine for after
        self.warmup_func = self._annealing_linear
        ...
        for group in self.optimizer.param_groups:
            ...
            for i, phase in enumerate(self._schedule_phases):
                ...
                if step_num <= end_step or i == len(self._schedule_phases) - 1:
                    ...
                    if i == 0:
                        computed_lr = self.warmup_func(group[phase['start_lr']], group[phase['end_lr']], pct)
                        if self.cycle_momentum:
                            computed_momentum = self.warmup_func(group[phase['start_momentum']], group[phase['end_momentum']], pct)
                    else:
